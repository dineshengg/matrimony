...
func log_duration(md *MiddleWare, f HandlerFunction) HandlerFunction {

	var internal_function = func(w http.ResponseWriter, r *http.Request) {
		t1 := time.Now()
		if f != nil {
			f(w, r)
		}
...
func authentication(md *MiddleWare, f HandlerFunction) HandlerFunction {

	internal_function := func(w http.ResponseWriter, r *http.Request) {
